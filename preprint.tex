...
\noindent {\LARGE \textbf{\textsf{Toward an open standard for ecological
data (via the \texttt{Julia} programming language)}}}
...
biodiversity monitoring systems based on open standards for data
representation, and how the Julia programming language can enable this.
